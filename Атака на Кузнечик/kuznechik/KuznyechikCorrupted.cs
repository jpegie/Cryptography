...
namespace kuznechik
{
    public class KuznechikCorrupted
    {
        ...
        public KuznechikCorrupted(byte[] mainKey)
        {
            _mainKey = mainKey;
            GenIterationsKeys();
        }

        public byte[] Encrypt(byte[] data, int injectionByteIndex, int injectionRound)
        {
